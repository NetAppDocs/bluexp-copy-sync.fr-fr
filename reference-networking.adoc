...
| \https://s3.amazonaws.com/ | Lorsque vous téléchargez les journaux de courtier de données depuis Cloud Sync, le courtier zippe son répertoire des journaux et télécharge les journaux vers un compartiment S3 prédéfini dans la région US-East-1. 
